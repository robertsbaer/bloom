    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {totalItems > 0 && (
            <div
              className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full text-sm font-sans"
      ...
      <main className="max-w-6xl mx-auto px-6 py-14">
        {sent ? (
          ...
          <div className="max-w-lg mx-auto text-center py-20">
            ...
            <h1 className="text-3xl mb-4" style={{ color: "#1e2d1f" }}>
              Inquiry Received!
            </h1>
            <p
              className="font-sans text-base leading-relaxed mb-2"
              style={{ color: "#6b5c45" }}
            >
              Thank you for your interest in carrying Bloom 5.5. We'll review
              your order and reach out within 2–3 business days with wholesale
              pricing and next steps.
            </p>
            <p className="font-sans text-sm mb-10" style={{ color: "#9c8870" }}>
              A confirmation will be sent to{" "}
              <strong style={{ color: "#1e2d1f" }}>{info.email}</strong>.
            </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-14">
              ...
              <p
                ...
                style={{ color: "#6b5c45" }}
              >
                Select the products and quantities you're interested in, then
                fill in your business details below. We'll follow up with
                wholesale pricing, minimums, and availability within 2–3
                business days.
              </p>
            </div>
            ...
            <div className="mb-16">
              <div className="flex items-baseline justify-between mb-8 flex-wrap gap-2">
                <h2 className="text-2xl" style={{ color: "#1e2d1f" }}>
                  Select Products
                </h2>
                {totalItems > 0 && (
                  <span
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                {products.map((product) => {
                  ...
                  const hasSelection = product.sizes.some(
                    (_, i) => (qty[`${product.id}-${i}`] ?? 0) > 0,
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <span
                          className="inline-block text-xs px-2 py-0.5 rounded-full font-sans mb-2"
                          style={{
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5 flex-shrink-0">
                                  ...
                                  <span
                                    className="w-7 text-center text-sm font-sans font-medium"
                                    style={{
                                      color: count > 0 ? "#1e3a20" : "#9c8870",
                                    }}
                                  >
                                    {count}
                                  </span>
                                  <button
                                    ...
                                    style={{
                                      borderColor:
                                        count > 0 ? "#1e3a20" : "#e0d8cc",
                                      color: count > 0 ? "#1e3a20" : "#6b5c45",
                                      backgroundColor:
                                        count > 0 ? "#f0f7f0" : "transparent",
                                    }}
                                    onMouseEnter={(e) =>
                                      (e.currentTarget.style.backgroundColor =
                                        count > 0 ? "#d4edcc" : "#f0ebe1")
                                    }
                                    onMouseLeave={(e) =>
                                      (e.currentTarget.style.backgroundColor =
                                        count > 0 ? "#f0f7f0" : "transparent")
            ...
            {totalItems > 0 && (
              <div
                className="rounded-2xl p-5 mb-10 flex items-center gap-4 flex-wrap"
                style={{
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    {totalItems} unit{totalItems !== 1 ? "s" : ""} selected
                    across {Object.values(qty).filter((v) => v > 0).length}{" "}
                    product size
                    {Object.values(qty).filter((v) => v > 0).length !== 1
                      ? "s"
                      : ""}
                  </p>
                  <p
            ...
            <div
              ...
              style={{
                backgroundColor: "#fff",
                boxShadow: "0 4px 32px rgba(30,58,32,0.06)",
              }}
            >
              <h2 className="text-2xl mb-1" style={{ color: "#1e2d1f" }}>
              ...
              <p
                ...
                style={{ color: "#9c8870" }}
              >
                Tell us about your business so we can send you wholesale pricing
                and terms.
              </p>
                  ...
                  [
                    {
                      ...
                      field: "businessName",
                      type: "text",
                      placeholder: "Sage & Bloom Boutique",
                      required: true,
                    },
                    {
                      label: "Contact Name",
              ...
              <div className="mb-8">
                ...
                <textarea
                  value={info.notes}
                  onChange={(e) =>
                    setInfo((p) => ({ ...p, notes: e.target.value }))
                  }
              ...
              {error && (
                <p
                  className="text-sm font-sans mb-5 px-4 py-3 rounded-xl"
              ...
              >
                <p className="text-xs font-sans" style={{ color: "#9c8870" }}>
                  * Required. We'll respond within 2–3 business days with
                  pricing and terms.
                </p>
                <button
                  type="submit"
      ...
      >
        <p
          ...
          style={{ color: "#9c8870" }}
        >
          © {new Date().getFullYear()} Bloom 5.5 by TB Naturals · Wholesale
          Portal ·{" "}
          <Link to="/" className="underline" style={{ color: "#a07840" }}>
            Back to store
          </Link>
        </p>
      </footer>
