...
const BRAND_ICON = `${BASE}bloom__social_icon_darkbg copy.png`;
...
export const products: Product[] = [
  // ─── Sets & Merch ─────────────────────────────────────────────────────────────
  {
    ...
    cardDescription:
      "A premium summer skincare set with Prickly Pear Seed Oil-powered body butter, facial moisturizer, and overnight serum, plus a Gua Sha and travel bag — all at 10% savings.",
    shortDescription:
      "A premium summer skincare set with Prickly Pear Seed Oil-powered body butter, facial moisturizer, and overnight serum, plus a Gua Sha and travel bag; all at 10% savings.",
  ...
  },
  {
    ...
    cardDescription:
      "A premium summer grooming set with Prickly Pear Seed Oil-powered beard oil, beard balm, and body butter for active men, plus a lightweight drawstring travel bag; all at 10% savings.",
    shortDescription:
      "A premium summer grooming set with Prickly Pear Seed Oil-powered beard oil, beard balm, and body butter for active men, plus a light-weight drawstring travel bag; all at 10% savings.",
  ...
  // ─── Body Care ─────────────────────────────────────────────────────────────
  {
    ...
    sizes: [
      { label: "4 fl oz", price: 22.0 },
      { label: "8 fl oz", price: 35.0 },
    ],
    image: `${BASE}images/products/Desert_Bloom_BB_4_oz_White.png`,
    sizeImages: [
      `${BASE}images/products/Desert_Bloom_BB_4_oz_White.png`,
      `${BASE}images/products/Desert_Bloom_BB_8_oz_White.png`,
    ],
    section: "Body Care",
    category: "Body",
    cardDescription:
      "A premium whipped body formula powered by Prickly Pear Seed Oil, crafted for active routines and clean, everyday care. It absorbs fast, feels weightless, and leaves skin soft, smooth, and comfortably conditioned.",
    shortDescription:
      "A premium whipped body formula powered by Prickly Pear Seed Oil, crafted for active routines and clean, everyday care. It absorbs fast, feels weightless, and leaves skin soft, smooth, and comfortably conditioned with a refined matte finish.",
    ...
    ingredients:
      "Butyrospermum Parkii (Shea) Butter, Mangifera Indica (Mango) Seed Butter, Theobroma Cacao (Cocoa) Butter, Opuntia Ficus-Indica Seed Oil, Simmondsia Chinensis (Jojoba) Seed Oil, Cannabis Sativa (Hemp) Seed Oil, Arrowroot Powder, Tocopherol.",
    heroIngredients: [
      "Prickly Pear Seed Oil",
      "Shea Butter",
      "Mango Butter",
    ...
    benefits: [
      "Light whipped texture absorbs fast without grease",
      "Prickly Pear provides antioxidant glow",
      "Hemp Seed Oil adds essential omegas for barrier support",
      "Arrowroot for natural matte, smooth finish",
      "Pearl Powder adds subtle healthy luminosity",
    ],
    bestFor:
      "Dry, sensitive body skin — especially legs, arms, elbows, and hands.",
    howToUse:
      "Apply generously to clean, damp or dry skin. Massage until absorbed. Use daily, especially after showering.",
  },
  // ─── Men's Care ─────────────────────────────────────────────────────────────
  {
    id: 3,
    ...
    sizes: [{ label: "2 oz", price: 20.0 }],
    image: `${BASE}images/products/Desert_Sage_Beard_Balm_Transparent.png`,
    section: "Men's Care",
    category: "Grooming",
    cardDescription:
      "A premium beard balm powered by Prickly Pear Seed Oil to soften coarse hair, tame flyaways, and leave beard and skin feeling smooth, conditioned, and polished.",
    shortDescription:
      "A premium beard balm powered by Prickly Pear Seed Oil to soften coarse hair, tame flyaways, and leave beard and skin feeling smooth, conditioned, and polished.",
    ...
    benefits: [
      "Deeply conditions coarse and dry beard hair",
      "Softens bristles and helps reduce itch",
      "Tames flyaways with light hold",
      "Nourishes and protects skin underneath",
      "Pearl Powder adds subtle healthy luminosity",
    ],
    bestFor:
      "All beard types and lengths, especially those with dry, coarse, or sensitive skin underneath.",
    scentProfile: "Cedarwood • Sandalwood • Vetiver • Sage (or Unscented)",
    howToUse:
      "Warm a small amount between palms. Work through beard and into the skin underneath. Style as desired. Use daily or as needed.",
  },
  {
    id: 4,
    ...
    sizes: [{ label: "1 fl oz", price: 15.0 }],
    image: `${BASE}images/products/Desert_Sage_Beard_Oil_Transparent.png`,
    section: "Men's Care",
    category: "Grooming",
    cardDescription:
      "A lightweight daily beard oil powered by Prickly Pear Seed Oil to soften hair, nourish skin, and add a natural sheen with a fast-absorbing, non-greasy finish.",
    shortDescription:
      "A lightweight daily beard oil powered by Prickly Pear Seed Oil to soften hair, nourish skin, and add a natural sheen with a fast-absorbing, non-greasy finish.",
    ...
    ingredients:
      "Opuntia Ficus-Indica Seed Oil, Simmondsia Chinensis (Jojoba) Seed Oil, Argania Spinosa (Argan) Kernel Oil, Rosa Canina (Rosehip) Seed Oil, Tocopherol, Pearl Powder, [Essential Oils: Cedarwood, Sandalwood, Vetiver, Salvia Officinalis (Sage)].",
    heroIngredients: [
      "Prickly Pear Seed Oil",
      "Jojoba Oil",
      "Argan Oil",
    ...
    benefits: [
      ...
      "Deeply conditions beard without greasiness",
      "Adds natural healthy shine and manageability",
      "Nourishes skin to reduce itch and flakiness",
      "Pearl Powder for subtle healthy luminosity",
    ],
    bestFor:
      "All beard types and lengths, especially dry, coarse, or sensitive skin underneath.",
    scentProfile: "Cedarwood • Sandalwood • Vetiver • Sage (or Unscented)",
    howToUse:
      "Apply 3–8 drops (depending on beard length) to clean or damp beard. Warm between palms and work through beard and into skin underneath. Use daily, morning or after washing.",
  },
  ...
  // ─── Face Care ─────────────────────────────────────────────────────────────
  {
    ...
    category: "Lip",
    cardDescription:
      "Nourishing lip balm with Mango and Shea Butters, Prickly Pear, and Red Raspberry Seed Oil. Pearl Powder adds a soft luminous finish for dry, chapped, or sensitive lips.",
    heroIngredients: [
      "Mango Butter",
      "Shea Butter",
      "Prickly Pear Seed Oil",
    ...
    benefits: [
      "Intensely nourishes and repairs dry, chapped lips",
      "Antioxidant boost from Prickly Pear & Red Raspberry",
      "Pearl Powder for soft luminous finish",
      "Rich yet comfortable, non-greasy wear",
      "Long-lasting hydration and softness",
    ],
    bestFor: "Dry, chapped, or sensitive lips.",
    howToUse:
      "Apply generously to lips as needed. Reapply after eating or drinking. Can be used as an overnight lip treatment.",
  },
  {
    id: 6,
    ...
    sizes: [{ label: "1 fl oz Airless Pump", price: 25.0 }],
    image: `${BASE}images/products/Midnight_Bloom_Serum.png`,
    section: "Face Care",
    category: "Serum",
    cardDescription:
      "A lightweight overnight dry-oil serum powered by Prickly Pear Seed Oil, Ceramides, and Bakuchiol for soft, radiant-looking skin with a smooth, non-greasy finish.",
    shortDescription:
      "A lightweight overnight dry-oil serum powered by Prickly Pear Seed Oil, Ceramides, and Bakuchiol for soft, radiant-looking skin with a smooth, non-greasy finish.",
    ...
    ingredients:
      "Opuntia Ficus-Indica (Prickly Pear) Seed Oil, Cannabis Sativa (Hemp) Seed Oil, Squalane, Simmondsia Chinensis (Jojoba) Seed Oil, Oenothera Biennis (Evening Primrose) Seed Oil, Rosa Canina (Rosehip) Seed Oil, Ceramide Complex, Tocopherol, Bakuchiol, Pearl Powder, Retinyl Palmitate.",
    heroIngredients: [
      "Prickly Pear Seed Oil",
      "Ceramides",
      "Bakuchiol",
    ...
    benefits: [
      "Supports skin barrier with Ceramides & Hemp Seed Oil",
      "Promotes smoother, more radiant skin overnight",
      "Powerful antioxidant protection",
      "Pearl Powder delivers subtle luminous glow",
      "Lightweight dry-oil — zero greasiness",
    ],
    bestFor: "Dry, mature, and sensitive skin.",
    howToUse:
      "Apply 4–6 drops to face and neck. Gently massage with hands or a jade, ice, or steel roller until absorbed. Use nightly. Can layer under moisturizer if desired.",
  },
  {
    id: 7,
    ...
    sizes: [{ label: "1 fl oz Airless Pump", price: 20.0 }],
    image: `${BASE}images/products/Radiance_Moisturizer.png`,
    section: "Face Care",
    category: "Face",
    cardDescription:
      "A lightweight daily moisturizer powered by Prickly Pear Seed Oil, Niacinamide, and skin-supporting Ceramides for hydrated, soft-looking skin with a refined luminous finish.",
    shortDescription:
      "A lightweight daily moisturizer powered by Prickly Pear Seed Oil, Niacinamide, and skin-supporting Ceramides for hydrated, soft-looking skin with a refined luminous finish.",
    ...
    ingredients:
      "Lavandula Angustifolia (Lavender) Flower Water, Opuntia Ficus-Indica Seed Oil, Squalane, Glycerin, Niacinamide, Butyrospermum Parkii (Mango) Butter, Theobroma Cacao (Cocoa) Butter, Simmondsia Chinensis (Jojoba) Seed Oil, Ricinus Communis (Castor) Seed Oil, Oenothera Biennis (Evening Primrose) Oil, Cetearyl Alcohol, Emulsifying Wax NF, Panthenol, Allantoin, Beta-Glucan, Centella Asiatica Extract, Arrowroot Powder, Pearl Powder, Leuconostoc/Radish Root Ferment Filtrate, Tocopherol, Ceramide NP.",
    heroIngredients: [
      "Prickly Pear Seed Oil",
      "5% Niacinamide",
      "Ceramides",
    ...
    benefits: [
      "5% Niacinamide brightens and supports skin barrier",
      "Ceramides and plant butters deliver nourishing hydration",
      "Centella, Panthenol & Beta-Glucan soothe and calm",
      "Pearl Powder for natural luminous finish",
      "Arrowroot offers subtle mattifying for balanced wear",
    ],
    bestFor: "Normal to dry, sensitive, or mature skin.",
    howToUse:
      "Apply small amount to clean face and neck morning and/or night. Massage until fully absorbed.",
  },
  {
    id: 8,
    ...
    sizes: [{ label: "1 fl oz Airless Pump", price: 20.0 }],
    image: `${BASE}images/products/Radiance_Lite_Moisturizer.png`,
    section: "Face Care",
    category: "Face",
    cardDescription:
      "A feather-light daily moisturizer powered by Prickly Pear Seed Oil, Niacinamide, and skin-conditioning botanicals for hydrated, smooth-looking skin with a refined luminous finish.",
    shortDescription:
      "A feather-light daily moisturizer powered by Prickly Pear Seed Oil, Niacinamide, and skin-conditioning botanicals for hydrated, smooth-looking skin with a refined luminous finish.",
    ...
    benefits: [
      "5% Niacinamide promotes brighter-looking skin",
      "Gentle Lactic Acid smooths skin texture",
      "Lightweight, fast-absorbing texture layers under SPF",
      "Pearl Powder for luminous finish",
      "Non-comedogenic, ideal under makeup",
    ],
    bestFor: "Normal, combination, sensitive, or acne-prone skin.",
    howToUse:
      "Apply pea-sized amount to face and neck AM/PM after serums. Absorbs quickly; excellent under makeup or SPF.",
  },
];
